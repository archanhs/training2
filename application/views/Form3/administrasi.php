    ...
    <table class="table table-hover" id="myTable">
        <thead>
            <tr>
                ...
                <th scope="col">Administrasi Umum</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <form action="<?= base_url() ?>form3/deleteadministrasi" method="POST">
                                <input type="hidden" name="id" value="<?= $value->id ?>">
                                <input type="hidden" name="name" value="<?= $value->administrasi ?>">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form3/addadministrasi') ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Administrasi</label>
                        <input type="text" class="form-control" name="administrasi" required>
                    </div>
                </div>
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form3/updateadministrasi') ?>" method="POST" id="formInput">
...
<script>
    $(".btn-edit").on("click", function() {
        ...
        $.ajax('<?= base_url('form3/getadministrasibyid') ?>', {
            ...
            success: function(data, status, xhr) {
                var html = `<div class="mb-3">
                        ...
                        <input type="hidden" name="old" value="${data.administrasi}">
					</div>
					<div class="mb-3">
						<label for="exampleInputPassword1" class="form-label">Administrasi</label>
						<input type="text" class="form-control" name="administrasi" value="${data.administrasi}" required>
					</div>`;
