...
<div class="table-responsive border border-secondary rounded-3 border-3 p-2">
    <table class="table table-hover" id="myTable">
        ...
        <tbody>
            <?php foreach ($kepribadian as $key => $value) { ?>
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <form action="<?= base_url() ?>form2/deletekepribadian" method="POST">
                                <input type="hidden" name="id" value="<?= $value->id ?>">
                                <input type="hidden" name="name" value="<?= $value->kepribadian ?>">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form2/addkepribadian') ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="kepribadian" required>
                    </div>
                </div>
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form2/updatekepribadian') ?>" method="POST" id="formInput">
...
<script>
    $(".btn-edit").on("click", function() {
        ...
        $.ajax('<?= base_url('form2/getkepribadianbyid') ?>', {
            ...
            success: function(data, status, xhr) {
                var html = `<div class="mb-3">
                        ...
                        <input type="hidden" name="old" value="${data.kepribadian}" >
					</div>
					<div class="mb-3">
						<label for="exampleInputPassword1" class="form-label">kepribadian</label>
						<input type="text" class="form-control" name="kepribadian" value="${data.kepribadian}" required>
					</div>`;
