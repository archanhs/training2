        ...
        <tbody>
            <?php foreach ($agama as $key => $value) { ?>
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <button type="button" class="btn btn-warning btn-sm btn-edit" data-bs-toggle="modal" data-bs-target="#modalEdit" id_agama=<?= $value->id ?>><i class="fa fa-pencil"></i></button>
                            <form action="<?= base_url() ?>form1/deleteagama" method="POST">
                                <input type="hidden" name="id" value="<?= $value->id ?>">
                                <input type="hidden" name="name" value="<?= $value->agama ?>">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form1/addagama') ?>" method="POST">
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form1/updateagama') ?>" method="POST" id="formInput">
...
<script>
    $(".btn-edit").on("click", function() {
        var id = $(this).attr('id_agama');
        console.log(id)
        $.ajax('<?= base_url('form1/getagamabyid') ?>', {
            ...
            success: function(data, status, xhr) {
                var html = `<div class="mb-3">
                        ...
                        <input type="hidden" name="old" value="${data.agama}" >
					</div>
					<div class="mb-3">
