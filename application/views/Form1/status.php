...
<h3>1.A.1.B.3. Status Sekarang</h3>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <form action="<?= base_url() ?>form1/deletestatus" method="POST">
                                <input type="hidden" name="id" value="<?= $value->id ?>">
                                <input type="hidden" name="name" value="<?= $value->status ?>">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form1/addstatus') ?>" method="POST">
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form1/updatestatus') ?>" method="POST" id="formInput">
...
<script>
    $(".btn-edit").on("click", function() {
        ...
        $.ajax('<?= base_url('form1/getstatusbyid') ?>', {
            ...
            success: function(data, status, xhr) {
                var html = `<div class="mb-3">
                        ...
                        <input type="hidden" name="old" value="${data.status}" >
					</div>
					<div class="mb-3">
